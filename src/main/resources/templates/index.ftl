...
<div class="container" id="main">
    <div class="col-md-12 col-sm-12 col-lg-10 col-lg-offset-1">
        <div class="panel panel-default qna-list">
            ...
            <#if result.result??>
                <#list result.result.content as question>
                    <li>
                        <div class="wrap">
                            <div class="main">
                                ...
                                <div class="auth-info">
                                    ...
                                    <a href="./user/profile.html" class="author">${question.writer.userId}</a>
                                </div>
                                <div class="reply" title="댓글">
                                    <i class="icon-reply"></i>
                                    <span class="point">${question.answers?size}</span>
                                </div>
                            </div>
                        </div>
                    </li>
            ...
            <div class="row">
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination center-block" style="display:inline-block;">
                        <#if result.prevPage??>
                            <li><a href="?page=${result.prevPage.pageNumber+1}">«</a></li>
                        </#if>
                        <#list result.pageList as page>
                            <li <#if page.pageNumber+1 == result.currentPageNum>class="page-item active"</#if>>
                                <a href="?page=${page.pageNumber + 1}">${page.pageNumber + 1}</a>
                            </li>
                        </#list>
                        <#if result.nextPage??>
                            <li><a href="?page=${result.nextPage.pageNumber+1}">»</a></li>
                        </#if>
                    </ul>
                </#if>
                </nav>
